...
interface IconNavigationCalendarProps {
    className?: string;
}

const NavigationCalendar: FC<IconNavigationCalendarProps> = ({ className }) => {
    return (
        ...
        //     <path d="M8 11H16" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        //     <path d="M8 16H12" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        // </svg>
